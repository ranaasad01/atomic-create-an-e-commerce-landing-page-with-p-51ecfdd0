...
const featuredProducts: Product[] = [
  {
    id: 1,
    name: "Aura Silk Blouse",
    category: "Women's Fashion",
    price: 89,
    originalPrice: 120,
    rating: 4.8,
    reviewCount: 214,
    image: "https://picsum.photos/seed/2de487af24ee/800/600",
    badge: "Best Seller",
    isSale: true,
  },
  {
    id: 2,
    name: "Obsidian Leather Watch",
    category: "Accessories",
    price: 245,
    rating: 4.9,
    reviewCount: 98,
    image: "https://matthew-mercury.com/cdn/shop/files/Black_B_men_S.jpg?v=1775931257",
    badge: "New",
    isNew: true,
  },
  {
    ...
    rating: 4.7,
    reviewCount: 176,
    image: "https://arveilo.com/cdn/shop/files/263.png?v=1740245214&width=1170",
    isSale: true,
  },
  {
    id: 4,
    ...
    rating: 4.6,
    reviewCount: 132,
    image: "https://m.media-amazon.com/images/I/61vHFTl2PvL._AC_UF894,1000_QL80_.jpg",
    badge: "New",
    isNew: true,
  },
  {
    ...
    rating: 4.9,
    reviewCount: 307,
    image: "https://www.gorsuch.com/cdn/shop/files/M05_FRAU_TEDDYL_CASH_168-216-0059-cashmere-2.jpg?v=1753037488&width=1500",
    badge: "Top Rated",
    isSale: true,
  },
  {
    ...
    rating: 4.5,
    reviewCount: 421,
    image: "https://theshopyohjiyamamoto.com/cdn/shop/files/MS-E02-061_1-1.jpg?v=1724356645&width=1445",
  },
];
...
const collections = [
  {
    ...
    subtitle: "Lightweight pieces for warm days",
    count: 48,
    image: "http://www.themeryl.com/wp-content/uploads/2022/06/summer-essentials-02.png",
    accent: "#e94560",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    count: 35,
    image: "https://cdn.homedsgn.com/wp-content/uploads/2016/11/RiverS-05.jpg",
    accent: "#c9a96e",
  },
];
...
const testimonials = [
  ...
  },
  {
    ...
    avatar: "https://media.licdn.com/dms/image/v2/D5603AQF3BJUWy9x8HQ/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1729135542036?e=2147483647&v=beta&t=1a5LYEgnKxsq9JwYKJcD3qfspZnLCvPy0oQmbFjzKhs",
    rating: 5,
    text: "I ordered the Obsidian Watch and it arrived beautifully packaged. The craftsmanship is outstanding. This is my go-to store for premium accessories.",
  },
  {
    id: 3,
    ...
    rating: 5,
    text: "The Cashmere Turtleneck is worth every penny. Soft, well-cut, and it photographs beautifully. My clients always ask where I source my pieces.",
  },
];
...
const valueProps = [
  ...
  },
  {
    ...
    description: "Every item is hand-selected by our in-house style team.",
  },
];
    ...
    >
      <motion.div variants={cardHover} className="flex flex-col h-full">
          ...
          >
            <Heart
              className={`w-4 h-4 transition-colors duration-200 ${
                wishlisted ? "fill-[#e94560] text-[#e94560]" : "text-[#1a1a2e]/50"
              }`}
            />
          </motion.button>
          {/* Quick add overlay */}
        ...
        <div className="p-4 flex flex-col gap-2">
          <p className="text-xs font-medium text-[#e94560] uppercase tracking-wider">
            {product.category}
          </p>
    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center bg-[#faf9f7] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.h1
              variants={fadeInUp}
              className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-[#1a1a2e] tracking-tight leading-[1.05] text-balance"
            >
              Style That
              <br />
            ...
            <motion.p
              variants={fadeInUp}
              className="text-lg text-[#1a1a2e]/60 leading-relaxed max-w-md text-pretty"
            >
            ...
            <motion.div variants={fadeInUp} className="flex items-center gap-6 pt-2">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full border-2 border-white bg-gradient-to-br from-[#e94560]/30 to-[#c9a96e]/30 overflow-hidden"
                  >
                    <img
                      src={`/images/customer-avatar-${i}.jpg`}
                      alt={`Customer ${i}`}
          ...
          >
            <motion.div variants={slideInRight} className="col-span-1 flex flex-col gap-3 lg:gap-4 pt-8">
              <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-[0_4px_8px_rgba(0,0,0,0.06),0_20px_40px_-12px_rgba(0,0,0,0.15)]">
                <img
                  src="https://www.refinery29.com/images/10888118.jpg?format=webp&width=720&height=1080&quality=85"
              ...
              <div className="aspect-square rounded-2xl overflow-hidden shadow-[0_4px_8px_rgba(0,0,0,0.06),0_20px_40px_-12px_rgba(0,0,0,0.15)]">
                <img
                  src="https://img.magnific.com/free-photo/luxury-fashion-woman-accessories-golden-heeled-shoes-little-evening-purse-elegant-style-vintage-style-sandals-footwear_285396-7237.jpg?semt=ais_hybrid&w=740&q=80"
            ...
            <motion.div variants={slideInRight} className="col-span-1 flex flex-col gap-3 lg:gap-4">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-[0_4px_8px_rgba(0,0,0,0.06),0_20px_40px_-12px_rgba(0,0,0,0.15)]">
                <img
                  src="https://cdn.shopify.com/s/files/1/0192/8012/products/minimalist-watch-black-brown-leather-dowling-brothers-analog-accessory-488.jpg"
              ...
              <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-[0_4px_8px_rgba(0,0,0,0.06),0_20px_40px_-12px_rgba(0,0,0,0.15)]">
                <img
                  src="https://static01.nyt.com/images/2025/01/14/multimedia/14STYLEOUTSIDE-WKLY-BERNICK-01-qvmf/14STYLEOUTSIDE-WKLY-BERNICK-01-qvmf-mobileMasterAt3x.jpg"
      ...
      <section id="products" className="py-24 md:py-32 bg-[#faf9f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              <motion.p variants={fadeInUp} className="text-xs font-semibold text-[#e94560] uppercase tracking-widest mb-2">
                Handpicked for You
              </motion.p>
            ...
            <motion.a
              variants={fadeInUp}
              href="#products"
              className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#e94560] hover:gap-2.5 transition-all duration-200 group"
            >
              View all products
          ...
          >
            {collections.map((col, idx) => (
              <motion.div
                ...
                className={`relative rounded-2xl overflow-hidden cursor-pointer group shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_-8px_rgba(0,0,0,0.12)] ${
                  idx === 1 ? "md:row-span-1 aspect-[4/5]" : "aspect-[4/5]"
                }`}
              >
                <img
                  src={col.image}
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  ...
                  <motion.span
                    whileHover={{ gap: "10px" }}
                    className="inline-flex items-center gap-2 text-white text-sm font-semibold group/btn"
                  >
                    Explore
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-[0_4px_8px_rgba(0,0,0,0.06),0_24px_48px_-12px_rgba(0,0,0,0.18)]">
                <img
                  src="https://cdn.sortiraparis.com/images/80/97216/726754-exposition-kandinsky-a-l-atelier-des-lumieres.jpg"
                  alt="Lumière atelier"
                  className="w-full h-full object-cover"
                />
              </div>
            ...
            <motion.div
              ...
              className="flex flex-col gap-6"
            >
              <motion.p variants={fadeInUp} className="text-xs font-semibold text-[#e94560] uppercase tracking-widest">
                Our Story
              </motion.p>
          ...
          >
            {testimonials.map((t) => (
              ...
              >
                ...
                <p className="text-[#1a1a2e]/70 text-sm leading-relaxed flex-1 text-pretty" style={{ color: "#1e1ef6" }}>
                  &ldquo;{t.text}&rdquo;
                </p>
